...
const AdminPortal = () => {
  ...
  const [courseDetails, setCourseDetails] = useState({
    fsreact2301: { name: 'fsreact2301', trainer: 'Arun', modules: 5, liveClassName: 'React Basics' },
    fsreact2304: { name: 'fsreact2304', trainer: 'Bhavesh', modules: 2, liveClassName: 'React Pro' },
    fsreact2305: { name: 'fsreact2305', trainer: 'Charan', modules: 6, liveClassName: 'Advanced React' },
    fspython2301: { name: 'fspython2301', trainer: 'Deepak', modules: 3, liveClassName: 'Python Bootcamp' },
    powerbi2304: { name: 'powerbi2304', trainer: 'Rahul', modules: 5, liveClassName: 'PowerBI Essentials' },
    awsdevops2307: { name: 'awsdevops2307', trainer: 'Kishan', modules: 1, liveClassName: 'AWS DevOps Intro' },
    awsdevops2308: { name: 'awsdevops2308', trainer: 'Rishi', modules: 2, liveClassName: 'AWS Advanced' },
    azuredevops2308: { name: 'azuredevops2308', trainer: 'Annu', modules: 3, liveClassName: 'Azure Tools' },
    azuredevops2301: { name: 'azuredevops2301', trainer: 'Vikas', modules: 4, liveClassName: 'Azure Basics' },
    azuredevops2303: { name: 'azuredevops2303', trainer: 'Madav', modules: 6, liveClassName: 'DevOps Pipeline' },
    fscorejava2302: { name: 'fscorejava2302', trainer: 'Vineet', modules: 5, liveClassName: 'Java Intro' },
    fscorejava2307: { name: 'fscorejava2307', trainer: 'Navneet', modules: 6, liveClassName: 'Java Advanced' },
  });
    ...
    <div className="flex flex-col h-screen text-gray-800 bg-white font-sans overflow-hidden">
      ...
      <div className="flex overflow-hidden">
        <div className="w-[200px] border-r border-gray-300">
          ...
          <div
            className={`px-4 py-2 text-m text-gray-500 font-semibold cursor-pointer ${
              section === 'users' ? 'bg-gray-100 border-none' : 'border-b border-gray-200'
            }`}
            onClick={() => {
              setSection('users');
              setShowCreateForm(false);
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            <div className="w-[240px] border-r border-gray-200 bg-white overflow-y-auto">
              ...
              {courses.map((course, index) => (
                <div
                  ...
                  className={`px-4 py-2 border border-gray-200 text-m text-gray-500 font-semibold cursor-pointer hover:bg-gray-100 ${
                    selectedCourse === course && !showCreateForm ? 'font-bold bg-gray-100' : ''
                  }`}
                >
                  {course}
                </div>
          ...
          <div
            className={`flex-1 px-8 py-6 overflow-auto w-full ${
              section === 'courses' ? 'shadow-[4px_0_6px_-4px_rgba(0,0,0,0.1)]' : ''
            }`}
          >
