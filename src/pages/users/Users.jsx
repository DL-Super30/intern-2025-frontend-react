    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <form>
                ...
                <div className="mt-1 ml-42">
                    ...
                    <div className="border border-blue-600 focus:outline-none focus:border-blue-600 px-3 py-2 inline-flex items-center space-x-3 w-[300px] rounded-sm">
                        <label
                            htmlFor="upload"
                            className="bg-gray-400 hover:bg-gray-600 hover:text-white p-1 text-center rounded-sm cursor-pointer"
                        >
                            Choose File
                            <input
                                type="file"
                        ...
                        <span className="text-gray-800 truncate w-40 text-sm">
                ...
                <div>
                    ...
                    {message && (
                        <p className={`mt-2 text-md ml-44 font-normal ${messageType === 'success' ? 'text-green-500' : 'text-red-500'}`}>{message}</p>
                    )}
                </div>
            </form>
            ...
            <form onSubmit={handleSubmit(findUser)}>
                ...
                {EmailMessage && (
                    <p className={`text-center font-medium mt-2 ${messageType === 'success' ? 'text-green-500' : 'text-red-500'}`}>{EmailMessage}</p>
                )}
