...
const AdminPortal = () => {
  ...
  const [CoursePage, setCoursePage] = useState({
    fsreact2301: { name: 'fsreact2301', trainer: 'Amit', ModulesPage: 3, liveClassName: 'React Basics' },
    fsreact2304: { name: 'fsreact2304', trainer: 'Sneha', ModulesPage: 4, liveClassName: 'React Pro' },
    fsreact2305: { name: 'fsreact2305', trainer: 'Ravi', ModulesPage: 5, liveClassName: 'Advanced React' },
    fspython2301: { name: 'fspython2301', trainer: 'Priya', ModulesPage: 6, liveClassName: 'Python Bootcamp' },
    powerbi2304: { name: 'powerbi2304', trainer: 'Nikita', ModulesPage: 2, liveClassName: 'PowerBI Essentials' },
    awsdevops2307: { name: 'awsdevops2307', trainer: 'Deepak', ModulesPage: 3, liveClassName: 'AWS DevOps Intro' },
    awsdevops2308: { name: 'awsdevops2308', trainer: 'Kiran', ModulesPage: 4, liveClassName: 'AWS Advanced' },
    azuredevops2308: { name: 'azuredevops2308', trainer: 'Anita', ModulesPage: 4, liveClassName: 'Azure Tools' },
    azuredevops2301: { name: 'azuredevops2301', trainer: 'Vikram', ModulesPage: 2, liveClassName: 'Azure Basics' },
    azuredevops2303: { name: 'azuredevops2303', trainer: 'Pooja', ModulesPage: 3, liveClassName: 'DevOps Pipeline' },
    fscorejava2302: { name: 'fscorejava2302', trainer: 'Rahul', ModulesPage: 4, liveClassName: 'Java Intro' },
    fscorejava2307: { name: 'fscorejava2307', trainer: 'Neha', ModulesPage: 5, liveClassName: 'Java Advanced' },
  });

  const tabs = ['Courses Info', 'ModulesPage', 'Projects', 'Resources', 'Enrolled', 'Resume'];
  ...
  const courses = Object.keys(CoursePage);
            ...
            {section === 'courses' && selectedCourse && !showCreateForm && (
              <>
                ...
                {activeTab === 'Courses Info' && (
                  <CoursesInfo key={selectedCourse} courseInfo={CoursePage[selectedCourse]} />
                )}
                {activeTab === 'ModulesPage' && <ModulesPage />}
